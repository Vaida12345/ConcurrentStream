...
extension ConcurrentStream {
    ...
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async throws -> some ConcurrentStream<T, any Error>) async -> some ConcurrentStream<T, any Error> {
    ...
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async throws -> some ConcurrentStream<T, Never>) async -> some ConcurrentStream<T, any Error> {
        await self.map(transform).flatten()
    }
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async -> some ConcurrentStream<T, some Error>) async -> some ConcurrentStream<T, any Error> {
        await self.map(transform).flatten()
    }
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async -> some ConcurrentStream<T, Never>) async -> some ConcurrentStream<T, Failure> {
        await self.map(transform).flatten()
    }
...
extension ConcurrentStream where Failure == Never {
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async throws -> some ConcurrentStream<T, some Error>) async -> some ConcurrentStream<T, any Error> {
        await self.map(transform).flatten()
    }
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T, E>(_ transform: @Sendable @escaping (Self.Element) async throws(E) -> some ConcurrentStream<T, Never>) async -> some ConcurrentStream<T, E> where T: Sendable, E: Error {
        await self.map(transform).flatten()
    }
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T, E>(_ transform: @Sendable @escaping (Self.Element) async -> some ConcurrentStream<T, E>) async -> some ConcurrentStream<T, E> where T: Sendable, E: Error {
        await self.map(transform).flatten()
    }
    ...
    /// This is a variant of ``ConcurrentStream/flatMap(_:)-6o6er``
    @inlinable
    public consuming func flatMap<T: Sendable>(_ transform: @Sendable @escaping (Self.Element) async -> some ConcurrentStream<T, Never>) async -> some ConcurrentStream<T, Never> {
        await self.map(transform).flatten()
    }
