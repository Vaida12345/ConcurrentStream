//
//  ConcurrentMapFromNonThrowingStream.swift
...
private final class ConcurrentMapFromNonThrowingStream<Element, SourceStream, Failure>: ConcurrentStream where SourceStream: ConcurrentStream, SourceStream.Failure == Never, Failure: Error {
    ...
    fileprivate init(source: SourceStream, work: @Sendable @escaping (_: SourceStream.Element) async throws(Failure) -> Element) async {
        self.source = source
...
extension ConcurrentStream {
    ...
    public consuming func map<T, E>(_ transform: @Sendable @escaping (Self.Element) async throws(E) -> T) async -> some ConcurrentStream<T, E> where E: Error, Failure == Never {
        await ConcurrentMapFromNonThrowingStream(source: self, work: transform) // self cannot be consumed
    }
